...
export class MemoirResolver {
  ...
  async getMemoir(@Info() info: GraphQLResolveInfo, @Args() args: GetMemoirArgs): Promise<Memoir | null> {
    ...
    const memoir = await this.memoirService.getMemoir(null, args.date, projection);
    return memoir;
  }

  @Mutation(() => Sleep)
  async addSleepRecord(@Args() args: SleepArgs): Promise<Sleep> {
    return await this.memoirService.updateMemoirSleep(null, args.date, args.input);
  }

  @Mutation(() => String)
  async addDiaryRecord(@Args() args: AddStringArgs): Promise<string> {
    return await this.memoirService.addMemoirField(null, args.date, 'diary', args.input);
  }

  @Mutation(() => String)
  async updateDiaryRecord(@Args() args: UpdateStringArgs): Promise<string> {
    return await this.memoirService.updateMemoirField(null, args.date, 'diary', args.index, args.update);
  }

  @Mutation(() => String)
  async deleteDiaryRecord(@Args() args: DeleteArgs): Promise<string> {
    return await this.memoirService.deleteMemoirField(null, args.date, 'diary', args.index);
  }

  @Mutation(() => String)
  async addEventRecord(@Args() args: AddStringArgs): Promise<string> {
    return await this.memoirService.addMemoirField(null, args.date, 'events', args.input);
  }

  @Mutation(() => String)
  async updateEventRecord(@Args() args: UpdateStringArgs): Promise<string> {
    return await this.memoirService.updateMemoirField(null, args.date, 'events', args.index, args.update);
  }

  @Mutation(() => String)
  async deleteEventRecord(@Args() args: DeleteArgs): Promise<string> {
    return await this.memoirService.deleteMemoirField(null, args.date, 'events', args.index);
  }
}
